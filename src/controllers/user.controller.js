...
const updateUserAvatar = asyncHandler(async(req,res)=>{
   ...
   const user = await User.findByIdAndUpdate(
    ...
    .status(200)
    .json(
        new ApiResponse(200,user,"Avatar image is update successfuly")
    )
})
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
   ...
   const user =  await User.findByIdAndUpdate(
    ...
    .status(200)
    .json(
        new ApiResponse(200,user,"Cover image is changes successfuly")
    )
})


export {registerUser, loginUser, logoutUser, refreshAccessToken,changeCurretPassword,getCurrentUser,updateAccountDetails,updateUserAvatar,updateUserCoverImage}